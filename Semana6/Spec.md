# Especificación — ADT Lista (Arreglo vs. Enlazada)
# 1. Propósito
 Una lista de reproducción guarda canciones en orden, permite consultarlas por posición, insertar y quitar canciones en cualquier lugar, y buscar si una canción ya está.

## 2. Fuera de alcance
- Sin interfaz ni audio real: solo se especifica la estructura de datos, no un reproductor funcional.
- Sin estructuras nativas como sustituto: prohibido usar list, dict, set, deque o heapq como la estructura pública que se evalúa. Un arreglo interno dentro de ListaArreglo sí es válido, por ser soporte de almacenamiento, no la estructura misma.
